...
namespace Vouchers.Services {
    ...
    export class VoucherService {
        getVouchers() {
            ...
            $.ajax({
                ...
                dataType: "json",
                success(data: Servicemodel.Vouchers.IVoucher[]) {
    ...
    export interface IVoucherTblOptions {
        data: Servicemodel.Vouchers.IVoucher[];
    ...
    export class VoucherTableBuilder {
        ...
        private getKeyValue(item: Servicemodel.Vouchers.IVoucher, fldName: string): string {
            let result: string = "";
    ...
    export class Voucher implements IVoucherObject {
        ...
        Expense: boolean;
        Remark?: boolean;
        Details?: Servicemodel.Vouchers.IVoucherDetail[];
    }
}

function consumeService() {
    var service = new Vouchers.Services.VoucherService();
    service.getVouchers().then((data: Servicemodel.Vouchers.IVoucher[]) => {
